...
/**
 * Configuração do consumidor Kafka para a saga de pagamentos.
 * Usa ack manual para garantir at-least-once dentro da saga.
 */
@Configuration
public class KafkaConfig {
    ...
    public ConsumerFactory<String, String> sagaConsumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "payments-saga");
